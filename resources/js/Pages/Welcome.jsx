...
export default function Welcome({ auth }) {
    ...
    useEffect(() => {
        const els = document.querySelectorAll('.wl-fadein-scroll');
        if (!els.length) return;
        const observer = new IntersectionObserver(
            (entries) => entries.forEach((e) => { if (e.isIntersecting) { e.target.classList.add('wl-visible'); observer.unobserve(e.target); } }),
            { threshold: 0.12 }
        );
        ...
        <>
            ...
            <div className="wl-page">
                ...
                <section className="wl-hero">
                    <div className="wl-hero-eyebrow wl-fadein" style={{ animationDelay: '0.05s' }}>
                        <span className="wl-hero-dot" aria-hidden="true" />
                        100% Free · No Downloads · No Subscription
                    </div>

                    <h1 className="wl-hero-title wl-fadein" style={{ animationDelay: '0.18s' }}>
                        Edit Videos Like&nbsp;a&nbsp;Pro.
                        <br />
                        <span className="wl-hero-accent">Free,&nbsp;Forever.</span>
                    </h1>

                    <p className="wl-hero-sub wl-fadein" style={{ animationDelay: '0.32s' }}>
                        A browser-based video editor built for everyone.
                        Cut, mix, add text and transitions - right in your browser.
                    </p>

                    <div className="wl-hero-ctas wl-fadein" style={{ animationDelay: '0.46s' }}>
                        <Link
                    ...
                    {/* Editor mockup */}
                    <div className="wl-mockup wl-fadein" style={{ animationDelay: '0.6s' }} aria-hidden="true">
                ...
                <section className="wl-features">
                    <div className="wl-section-label wl-fadein-scroll">What you get</div>
                    <h2 className="wl-section-title wl-fadein-scroll" style={{ animationDelay: '0.1s' }}>
                        Everything you need. Nothing else.
                    </h2>
                    <div className="wl-feat-grid">
                        {FEATURES.map((f, i) => (
                            <div
                                className="wl-feat-card wl-fadein-scroll"
                                key={f.title}
                ...
                <section className="wl-bottom-cta">
                    <div className="wl-bottom-cta-inner wl-fadein-scroll">

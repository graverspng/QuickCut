...
export default function AudioDashboard({ projects = [] }) {
    ...
    const createProject = (e) => {
        ...
        router.post(route('audio.projects.store'), { name }, {
            onSuccess: () => { setToastMsg('Audio project created'); closeModal(); },
    ...
    const toggleFavorite = (project) => {
        ...
        router.put(route('audio.projects.update', project.id), { favorited_project: next }, {
            preserveScroll: true,
            preserveState:  true,
        ...
        <AuthenticatedLayout>
                ...
                <div className="db-wrapper">
                    ...
                    <header className="db-hero">
                        <div className="db-hero-left">
                            ...
                            <h1 className="db-hero-title">Audio Projects</h1>
                            <p className="db-hero-sub">Create, manage, and edit your audio projects.</p>
                        </div>
                    ...
                    <div className="db-grid">
                        ...
                        <div
                            ...
                            aria-label="Create new audio project"
                        >
                            <div className="pcard-new-plus" aria-hidden="true">+</div>
                            <span className="pcard-new-label">New Audio Project</span>
                        ...
                        {projects.length === 0 && (
                            <div className="db-empty">
                                ...
                                <p className="db-empty-text">No audio projects yet — create your first one!</p>
                            </div>
                        )}
            ...
            {showModal && (
                <div className="modal-overlay" onMouseDown={(e) => e.target === e.currentTarget && closeModal()}>
                    <div className="modal-card" role="dialog" aria-modal="true" aria-labelledby="create-audio-title">
                        <h2 id="create-audio-title" className="modal-card-title">Name your audio project</h2>
